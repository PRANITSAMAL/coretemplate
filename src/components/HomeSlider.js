...
const HomeSlider = () => {
  ...
  <div className="slider-item slide1" style={{"backgroundImage":"url(assets/images/slider/slider-bg-1.jpg)"}}>
      ...
      <div className="row">
        <div className="col-12">
          ...
          <div className="content style text-center">
            ...
            <a href="/about" className="btn btn-main btn-white" data-animation-in="slideInLeft" data-duration-in="1.2">explore</a>
          </div>
  ...
  <div className="slider-item" style={{"backgroundImage":"url(assets/images/slider/slider-bg-2.jpg)"}}>
    <div className="container">
      <div className="row">
        <div className="col-12">
          ...
          <div className="content style text-center">
            ...
            <a href="/about" className="btn btn-main btn-white" data-animation-in="slideInRight" data-duration-in="1.2">about us</a>
          </div>
      ...
      <div className="row">
        <div className="col-12">
          ...
          <div className="content text-center style">
            ...
            <a href="/about" className="btn btn-main btn-white" data-animation-in="slideInRight"  data-duration-in="1.2">shop now</a>
          </div>
